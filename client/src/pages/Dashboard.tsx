        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="space-y-4">
            ...
            {[
              ...
              { label: 'Nutrition Plan', desc: 'Your personalized diet', icon: <Utensils size={18} />, view: 'diet' as const },
            ].map(action => (
              <button
                key={action.label}
            ...
            {dietPlan && (
              ...
              >
                ...
                <div className="grid grid-cols-3 gap-2 mt-3">
                  {[
                    { label: 'Protein', pct: dietPlan.macros.protein },
                    { label: 'Carbs', pct: dietPlan.macros.carbs },
                    { label: 'Fat', pct: dietPlan.macros.fat },
                  ].map(m => (
                    <div key={m.label}>
                      <div className="cx-progress-bar mb-1">
                        <div className="cx-progress-fill" style={{ width: `${m.pct}%` }} />
                      </div>
